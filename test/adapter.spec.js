...
describe('jasmine adapter', () => {
  ...
  describe('getRelevantStackForm', () => {
    ...
    it('should split by newline and return all values for which isExternalStackEntry returns true', () => {
  ...
  describe('getGrepOption', () => {
    it('should get grep option from config if args is array', () => {
    ...
    it('should get grep option from args if args is string', () => {
      expect(getGrepOption('--grep=test')).toEqual('test')
    })
